  ...
  constructor(props) {
    ...
    this.imgSrc =
      this.props.data.type === 0
        ? "https://www.flaticon.com/svg/static/icons/svg/3182/3182079.svg"
        : "https://www.flaticon.com/svg/static/icons/svg/2949/2949689.svg";
    this.stmt = `A ${
      this.props.data.type === 0 ? "mask" : "social distancing"
    } event occured, near camera no: ${
      this.props.data.CAMID == null ? "NA" : this.props.data.CAMID
    }`;
    this.openVideo = this.openVideo.bind(this);
  }
  openVideo() {
    if (this.props.data.PATHURL == null) return;
