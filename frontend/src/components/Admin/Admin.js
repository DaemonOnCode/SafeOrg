        ...
        return(
          <div className={styles.mainCon}>
              ...
              <div className={styles.reportCon}>
                <ReportCard type="0" timeline="0">
                      
                </ReportCard>
                <ReportCard type="0" timeline="">

                </ReportCard>
                <ReportCard type="1" timeline="0">

                </ReportCard>
                <ReportCard type="1" timeline="1">

                </ReportCard>
              </div>
              <div className={styles.miscCon}>
                <div style={{maxHeight: "30rem", overflowY: "scroll"}}> <FeedCon></FeedCon> </div>
